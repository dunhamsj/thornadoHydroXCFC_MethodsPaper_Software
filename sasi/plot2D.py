...
for iSS in SS:
    ...
    figName = figNameRoot + '_t{:}.pdf'.format(str(np.int64(time)).zfill(2))
    ...
    ax.text(0.6, 0.92, r'$t = {:.0f}\ \mathrm{{ms}}$'.format(time), fontsize = 12, transform = ax.transAxes)
    ...
    cb.set_label(r'{:}'.format(zLabel), fontsize = 16)
